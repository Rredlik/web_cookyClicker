...
BOOST_TYPE_CHOICES = {
    (BOOST_TYPE_NAME_TO_NUMBER['first'], 'first'),
    (BOOST_TYPE_NAME_TO_NUMBER['second'], 'second'),
    (BOOST_TYPE_NAME_TO_NUMBER['third'], 'third'),
    (BOOST_TYPE_NAME_TO_NUMBER['four'], 'four'),
    (BOOST_TYPE_NAME_TO_NUMBER['fifth'], 'fifth'),
}

BOOST_TYPE_VALUES = {
    BOOST_TYPE_NAME_TO_NUMBER['first']: {
        'click_power_scale': 1,
    ...
    BOOST_TYPE_NAME_TO_NUMBER['second']: {
        'click_power_scale': 0,
    ...
    BOOST_TYPE_NAME_TO_NUMBER['third']: {
        'click_power_scale': 0,
        'auto_click_power_scale': 1,
        'boost_number': 3,
        'need_level': 4,
    ...
    BOOST_TYPE_NAME_TO_NUMBER['four']: {
        'click_power_scale': 0,
        'auto_click_power_scale': 1,
        'boost_number': 4,
        'need_level': 5,
        'base_click_power': 300,
        'base_price': 150000,
        'price_scale': 1.3,
    },
    BOOST_TYPE_NAME_TO_NUMBER['fifth']: {
        'click_power_scale': 0,
        'auto_click_power_scale': 1,
        'boost_number': 5,
        'need_level': 6,
